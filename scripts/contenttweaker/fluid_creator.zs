...
(//声明函数所需参数
    ...
    color as string,
    colorize as bool,//实际材质是否受颜色参数影响
    density as int,//密度，决定实体在其游泳速度，水为1000，熔岩为3000
    gaseous as bool,//流体是否反重力流动
...
fAN.colorize = colorize;
fAN.density = density;
fAN.gaseous = gaseous;
fAN.luminosity = luminosity;
fAN.material = material;
fAN.rarity = rarity;
var stillLocation as string = "dlmbfcdlmmodpackcertification:fluids/" ~ ID ~ "_still";//材质加载位置受限
fAN.stillLocation = stillLocation;
var flowingLocation as string = "dlmbfcdlmmodpackcertification:fluids/" ~ ID ~ "_flow";
fAN.flowingLocation = flowingLocation;
fAN.temperature = temperature;
fAN.vaporize = vaporize;
